        ...
        <div key={i} class="flex w-full items-stretch justify-center gap-2">
          ...
          >
            <span
              ...
              dangerouslySetInnerHTML={{ __html: p.aksiSvg }}
            />
          ...
          <div class="flex flex-1 flex-col items-center gap-1 rounded-xl border-2 border-rubina-sunny-200 bg-rubina-sunny-50 p-3 text-center shadow-card">
            {buka[i] ? (
              <>
                <span
                  class="game-pop inline-block h-16 w-16 sm:h-20 sm:w-20"
                  dangerouslySetInnerHTML={{ __html: p.hasilSvg }}
                />
              ...
              <>
                <span
                  class="flex h-16 w-16 items-center justify-center text-3xl sm:h-20 sm:w-20"
                  aria-hidden="true"
                >
                  ❓
                </span>
